...
def trainNet(X,Y, DX,DY,TX,TY,config, user_size,train=True, save=True):
    ...
    with graph.as_default():
        ...
        #word_embeddings = tf.Variable(W2V, trainable=False, name="word_embeddings")  # FUNCIONA??? https://stackoverflow.com/questions/37326002/is-it-possible-to-make-a-trainable-variable-not-trainable/37327561
...
#-----------------------------------------------------------------------------------------------------------------------
'''
X, Y, DX, DY, TX, TY, user_size = getData(REAL_SONG_IDS=REAL)
...
config = {"batch_size": 1024, "learning_rate": 0.000001, "epochs": 410, "seed": 100}
